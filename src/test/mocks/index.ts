...
export const locationPerEpisodeResponse = [
  {
    charactersQuantity: 19,
    episode: "S01E01",
    locations: ["Earth (C-137)", "unknown", undefined],
    locationsQuantity: 3,
    name: "Pilot",
  },
  {
...
export const resultsCharCounter = [
  {
    char: "l",
    count: 1,
    resource: "location",
...
export const resultsEpisodeLocations = [
  {
    charactersQuantity: 19,
    episode: "S01E01",
    locations: ["Earth (C-137)", "unknown", undefined],
